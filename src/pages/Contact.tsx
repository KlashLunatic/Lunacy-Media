              ...
              <div className="md:col-span-3 flex items-center justify-center">
                <div className="text-center space-y-8 py-20">
                  ...
                  <p className="text-xl text-muted font-inter font-light leading-relaxed max-w-md mx-auto">
                    Thank you for reaching out. We'll be in touch within 24 hours on business days.
                  </p>
                </div>
              </div>
            ) : (
              ...
              >
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="strategy-audit-intro-call">Strategy Audit / Intro Call</option>
                    <option value="nebula-foundational-identity">Nebula — Foundational Identity</option>
                    <option value="neutron-narrative-brand-system">Neutron — Narrative Brand System</option>
                    <option value="nova-full-creative-ecosystem">Nova — Full Creative Ecosystem</option>
                    <option value="orbit-creative-direction-retainer">Orbit — Creative Direction Retainer</option>
